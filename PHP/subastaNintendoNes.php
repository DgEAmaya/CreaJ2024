...
<head>
  ...
  <title>subastaNintendoNes</title>
                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for">
                          ...
                          <img class="imagenProduc" src="../Imagenes/nintendoNes.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/NintendoNees.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/NES-Pak-Mario123Pak__77877.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/juegos_nees.webp" style="width:90%;">
                          </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/nintendoNes.jpg" style="width:100%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/NintendoNees.jpg" style="width:100%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/NES-Pak-Mario123Pak__77877.jpg" style="width:100%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/juegos_nees.webp" style="width:100%;">
                              </div>
                      ...
                      <div id="produ" class="col-5 m-4" style="display: flex;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Nintendo NES</p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>Nintendo NES en muy buen estado no se a utilizado mucho,
                            uno de los botones del control no funciona pero la consola ensi esta muy bien cuidada y funcinal
                            </p>
                          </div>
                          ...
                          function actualizarContador() {
                              const fechaFinal = new Date('2024-08-01T12:00:00Z'); // Fecha y hora de finalización de la subasta
