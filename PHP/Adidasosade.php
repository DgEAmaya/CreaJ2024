...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand">
    <a class="navbar-brand ps-3" href="index.html"><img src="../Imagenes/logo-mini.png" width="60"></a></a>
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    <div class="sb-sidenav-menu-heading">Menu</div>
                      <a class="nav-link collapsed" href="../HTML/index.html" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                      ...
                      <div class="sb-nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-dollar" viewBox="0 0 16 16">
                    ...
                    <a class="nav-link" href="../HTML/Donaciones.html">
                      <div class="sb-nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-paper-heart-fill" viewBox="0 0 16 16">
                    ...
                    <a class="nav-link" href="../HTML/Reclamaciones.html">
                      <div class="sb-nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-break-fill" viewBox="0 0 16 16">
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                        <div class="sb-nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
                        ...
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                          <a class="nav-link" href="../HTML/Contactanos.html">
                            ...
                            <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="401.html">Facebook</a>
                                    <a class="nav-link" href="404.html">whatsapp</a>
                                    <a class="nav-link" href="500.html">Instagram</a>
                                    <a class="nav-link" href="500.html">X </a>
                                </nav>
                            </div>

                        </nav>
                    </div>
                    <a class="nav-link" href="../HTML/politicasPrivacidadYmas.html">
              ...
              <div class="container">
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for" style="margin-top: -100px;">
              
                          <div class="conteImagenProduc">
                          <img class="imagenProduc" src="../Imagenes/zapatillas_Osade.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/osade2.webp" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/osade3.webp" style="width:90%;">
                          </div>
                        </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/zapatillas_Osade.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/osade2.webp" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/osade3.webp" style="width:90%;">
                              </div>
                          </div>
                          </section>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex; padding-top:0px;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Zapatos Adidas Osade </p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>Los tenis Adidas OSADE son una opción moderna y versátil para quienes buscan combinar estilo y rendimiento. Diseñados con materiales de alta calidad, estos tenis ofrecen comodidad y durabilidad. Su estética contemporánea, con detalles distintivos de la marca Adidas, los hace ideales tanto para actividades deportivas como para el uso diario. La suela proporciona un excelente soporte y tracción, asegurando una pisada firme y segura. Perfectos para quienes buscan una combinación de moda y funcionalidad en su calzado deportivo.</p>
                                ...
                                <!-- JavaScript -->
                                    <script>
                                        ...
                                        function actualizarContador() {
                                            const fechaFinal = new Date('2024-07-03T12:00:00Z'); // Fecha y hora de finalización de la subasta
