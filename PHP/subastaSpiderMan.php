                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for">
                          ...
                          <img class="imagenProduc" src="../Imagenes/spiderman.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/spiderMan1.jpeg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/spiderMan2.jpeg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/spiderMan3.jpeg" style="width:90%;">
                          </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/spiderman.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/spiderMan1.jpeg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/spiderMan2.jpeg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/spiderMan3.jpeg" style="width:90%;">
                              </div>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Figura de Spider-Man de Marvel</p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>La figura de Spider-Man, interpretado por Tom Holland, está completamente nueva y viene en 
                                su caja original, sellada y sin daños. Incluye todos los accesorios originales como manos 
                                intercambiables y telarañas. La figura está en perfectas condiciones, con detalles de pintura 
                                impecables y articulaciones completamente funcionales, permitiendo múltiples poses. Ideal para 
                                coleccionistas que buscan una pieza intacta y sin signos de uso.
                            </p>
                          </div>
