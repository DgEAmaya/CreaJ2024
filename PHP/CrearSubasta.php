...
<body class="sb-nav-fixed">
  ...
  <section class="intro">
    <div class="CrearSubastaCard bg-image h-100">
                ...
                <div class="row g-0">
                  <div class="col-md-4 d-none d-md-block">
                    <form class="dropzone-box">
                      <h2 style="color: #000000;">Selecciona las imagenes del producto</h2>
                      <p>Presiona para subir una imagen</p>
                      <div class="dropzone-area">
                        ...
                        <p class="file-info">No has seleccionado ningun archivo</p>
                      </div>
                  ...
                  <div class="col-md-8 d-flex align-items-center">
                    <div class="card-body py-5 px-4 p-md-5">
                      <h4 class="fw-bold mb-4" style="color: #57070C;">Crear Subasta</h4>
                      <form action="" method="POST" id="auction-form">
                        <div class="form-outline mb-2">
                          <label class="form-label" for="form2Example1" style="color: #000000;">Nombre del Producto</label>
                          <input type="text" id="form2Example1" class="form-control" name="producto" required />
                        </div>

                        <div class="form-outline mb-2">
                          <label class="form-label" for="form2Example4" style="color: #000000;">Categoría</label>
                          <select id="form2Example2" class="form-select" name="categoria" required>
                            <option value="">Seleccionar</option>
                            <option value="Entretenimiento">Entretenimiento</option>
                            <option value="Moda">Moda Urbana</option>
                          </select>
                        </div>

                        <div class="form-outline mb-2">
                          <label class="form-label" for="form2Example1" style="color: #000000;">Descripción del artículo</label>
                          <input type="text" id="form2Example3" class="form-control" name="descripcion" required />
                        </div>

                        <div class="form-outline mb-2">
                          <label class="form-label" for="form2Example3" style="color: #000000;">Precio del artículo ($)</label>
                          <input type="text" id="form2Example4" class="form-control" name="precio" required />
                        </div>

                        

                        <div class="form-outline mb-2">
                          <label class="form-label" for="form2Example5" style="color: #000000;">Estado del Producto</label>
                          <select id="form2Example5" class="form-select" name="estado" required>
                            <option value="">Seleccionar</option>
                        ...
                        <div class="form-outline mb-2">
                          <label class="form-label" for="form2Example6" style="color: #000000;">Tiempo de Subasta (En días)</label>
                          <input type="number" id="form2Example6" class="form-control" name="tiempo" min="1" required />
                        </div>

                        <div class="pt-1 mb-2">
                          <button class="btn btn-primary btn-md btn-block" type="submit" style="background-color: #57070C; border-color: #57070C;">Crear Subasta</button>
                        </div>
                      </form>
                    </div>
                  </div>
