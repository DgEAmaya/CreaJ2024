...
<img src="../Imagenes/9.png" width="100%"  class="img-fluid max-width: 100%;" alt="imgDonaciones">
  ...
  <tbody>
    <tr>
        ...
        <th> <?php echo $Rol ?> </th>
        <th>
          <a class="visual" href="update.php?idCliente=<?php echo $row['idCliente']?>"><button class="btn reseñasbtn btn-warning"><i class="bi bi-flag-fill"></i></button></a>
          <a class="visual" href="delete_user.php?idCliente=<?php echo $row['idCliente']?>"><BUtton class="btn reseñasbtn btn-danger"><i class="bi bi-trash3-fill"></i></BUtton> </a>
        </th>            
    </tr>
  </tbody>
  <?php 
