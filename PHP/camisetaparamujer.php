...
<head>
  ...
  <title>Camiseta para mujer</title>
                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for" style="margin-top: -100px;">
                          ...
                          <img class="imagenProduc" src="../Imagenes/camiseta_mujer.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/camisetamujer2.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/camisetamujer3.jpg" style="width:90%;">
                          </div>
                        </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/camiseta_mujer.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/camisetamujer2.jpg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/camisetamujer3.jpg" style="width:90%;">
                              </div>
                          </div>
                          </section>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex; padding-top:0px;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Camisa para mujer</p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>La camiseta de verano para mujer en azul marino con estampado de flores es una prenda ideal para los días cálidos. Diseñada con un cuello redondo y un corte holgado, ofrece comodidad y un estilo relajado. Su tejido suave y ligero la hace perfecta para mantenerse fresca, mientras que el estampado floral añade un toque de feminidad y frescura. Esta blusa corta es versátil y fácil de combinar, ideal para un look casual y cómodo en verano.</p>
                                ...
                                <!-- JavaScript -->
                                    <script>
                                        ...
                                        function actualizarContador() {
                                            const fechaFinal = new Date('2024-06-29T12:00:00Z'); // Fecha y hora de finalización de la subasta
                         ...
                         <div class="walletBalanceCard">
                            ...
                            <div class="balancewrapper">
                              ...
                              <p class="balance"><span id="currency">$</span>20.12</p>
                            </div>
