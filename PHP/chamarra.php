...
<head>
  ...
  <title>Chaqueta de cuero para hombre</title>
                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for" style="margin-top: -100px;">
                          ...
                          <img class="imagenProduc" src="../Imagenes/Chaqueta.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/chaqueta2.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/chaqueta3.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/chaqueta4.jpg" style="width:90%;">
                          </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/Chaqueta.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/chaqueta2.jpg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/chaqueta3.jpg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/chaqueta4.jpg" style="width:90%;">
                              </div>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex; padding-top:0px;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Chaqueta De Cuero Para Hombre </p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>La chaqueta biker de cuero negro con cremallera, hecha de cuero de alta calidad, ofrece un diseño clásico con cremalleras metálicas, solapas anchas y hebillas ajustables. Su silueta ajustada aporta un toque de rebeldía y sofisticación, perfecta para diversas ocasiones.</p>
