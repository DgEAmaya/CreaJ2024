                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for">
                          ...
                          <img class="imagenProduc" src="../Imagenes/JordanSPI.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/jordan-spizike 2.webp" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/jordan3.png" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/jordan4.webp" style="width:90%;">
                          </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/JordanSPI.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider" >
                              <img class="imagenslider" src="../Imagenes/jordan-spizike 2.webp" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/jordan3.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/jordan4.webp" style="width:90%;">
                              </div>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex;  padding-top:0px;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Jordan 3 Spizike</p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>El Air Jordan 3 no solo marcó un avance en el diseño y la tecnología de calzado deportivo, sino que también se convirtió en un símbolo de la influencia duradera de Michael Jordan en la cultura popular y la moda.</p>
                                ...
                                <!-- JavaScript -->
                                    <script>
                                        ...
                                        function actualizarContador() {
                                            const fechaFinal = new Date('2024-07-02T12:00:00Z'); // Fecha y hora de finalización de la subasta
