...
<head>
  ...
  <title>Camiseta sportswear</title>
                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for">
                          ...
                          <img class="imagenProduc" src="../Imagenes/Camiseta_Sportswear.png" style="width:100%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/sportwear2.jpg" style="width:100%;">
                          </div>
                        </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/Camiseta_Sportswear.png    " style="width:100%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/sportwear2.jpg" style="width:100%;">
                              </div>
                          </div>
                          </section>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Camiseta sportswear</p>
                                ...
                                <!-- JavaScript -->
                                    <script>
                                        ...
                                        function actualizarContador() {
                                            const fechaFinal = new Date('2024-06-23T12:00:00Z'); // Fecha y hora de finalización de la subasta
