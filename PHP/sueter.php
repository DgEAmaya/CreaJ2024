                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for" style="margin-top: -100px;">
                          ...
                          <img class="imagenProduc" src="../Imagenes/sueter.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/sueter2.webp" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/sueter3.webp" style="width:90%;">
                          </div>
                        </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/sueter.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/sueter2.webp" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/sueter3.webp" style="width:90%;">
                              </div>
                          </div>
                          </section>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex; padding-top:0px;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Sueter VERO MODA </p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>El polo de cuello alto VERO MODA en color fucsia es una prenda elegante y sostenible, confeccionada con un 52% de poliéster reciclado, 42% de poliéster, 3% de elastano y 3% de nailon. Este diseño combina estilo y comodidad, ofreciendo una silueta ajustada y un tejido suave y elástico que se adapta perfectamente al cuerpo. Ideal para un look sofisticado y moderno, este polo de cuello alto es una excelente opción para diversas ocasiones.</p>
