                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for">
                          ...
                          <img class="imagenProduc" src="../Imagenes/figuraGoku.jpg" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/PRE-SALE-BANDAI-S-H-Figuarts-Dragon-Ball-Z-Son-Goku-Super-Saiyan-Exclusive-Edition-145MM.webp" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/figuraGoku3.jpg" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/figuraGoku4.jpg" style="width:90%;">
                          </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/figuraGoku.jpg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/PRE-SALE-BANDAI-S-H-Figuarts-Dragon-Ball-Z-Son-Goku-Super-Saiyan-Exclusive-Edition-145MM.webp" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/figuraGoku3.jpg" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/figuraGoku4.jpg" style="width:90%;">
                              </div>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Figura de Dragon Ball</p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>Esta figura captura la esencia poderosa y dinámica de Goku en uno de sus momentos más icónicos. 
                              Con detalles meticulosos y colores vibrantes, esta representación de Goku en su forma Super Saiyan 
                              durante la saga de Namek no solo es una obra de arte visual, sino también una pieza imprescindible 
