  ...
  <section>
    ...
    <div class="tablasreviews mx-5 ">
      <table class="table table-hover mx-auto">
        ...
        <tr>
          <th scope="col"><input class="col-md-12" type="checkbox"></option></th>

          <th scope="col"><img src="../Imagenes/air-jordan-4-retro-red-thunder-sneakcenter-1-34785014186251.webp" width="80px" alt="">Jordan 4 retro</th>

          <th scope="col"> <img src="../Imagenes/xavier.jpeg" width="50px" class="rounded-circle mx-2" alt="">XavierCARIES2033</th>

          <th scope="col"><i class="bi star bi-star-fill "><i class="bi star bi-star-fill "><i class="bi star bi-star-fill "><i class="bi star bi-star-fill "><i class="bi bi-star-half"></i></i></th>

          <th scope="col">No tube ninguna complicacion para que me llegara mi paquete a mi casa</th>

          <th scope="col">20/03/24</th>

          <th scope="col">

            <div class="columnasbtn d-flex">

              <BUtton class="btn reseñasbtn btn-danger"><i class="bi bi-trash3-fill"></i></BUtton>
              <button class="btn reseñasbtn btn-warning"><i class="bi bi-flag-fill"></i></button>
        ...
        <tr>
          ...
          <th scope="col"> <img src="../Imagenes/xavier.jpeg" width="50px" class="rounded-circle mx-2" alt="">ElChanclas300 </th>
