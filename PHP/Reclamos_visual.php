...
<img src="../Imagenes/9.png" width="100%"  class="img-fluid max-width: 100%;" alt="imgDonaciones">
                ...
                if ($conex==true) {
                    ...
                    if ($sql){
                        while ($row = $resultado->fetch_array()){
                            $nombreReclamo   = $row['nombreReclamo'];
                            $correoReclamo   = $row['correoReclamo'];
                            $telefonoReclamo = $row['telefonoReclamo'];
                            $mensaje         = $row['mensaje'];
                            $fecha           = $row['fecha'];
  ...
  <tbody>
    <tr>
                <th> <?php echo $nombreReclamo?> </th>
                <th> <?php echo $correoReclamo?> </th>
                <th> <?php echo $telefonoReclamo?> </th>
