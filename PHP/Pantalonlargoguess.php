...
<head>
  ...
  <title>Pantalon Largo GUESS</title>
                  ...
                  <div class="fila d-flex">
                      <div class="col-5 sm-12 w-100 ">
                        <div class="slider-for" style="margin-top: -100px;">
                          ...
                          <img class="imagenProduc" src="../Imagenes/Pantalon_GUESS.png" style="width:90%; justify-content: center;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/guess2.webp" style="width:90%;">
                          </div>
                          
                          <div>
                          <img class="imagenProduc" src="../Imagenes/guess3.webp" style="width:90%;">
                          </div>
                        </div>
                          ...
                          <div class="slider-nav">
                              ...
                              <img class="imagenslider" src="../Imagenes/Pantalon_GUESS.png" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/guess2.webp" style="width:90%;">
                              </div>
                              
                              <div class="conteImagenesSlider">
                              <img class="imagenslider" src="../Imagenes/guess3.webp" style="width:90%;">
                              </div>
                          </div>
                          </section>
                      ...
                      <div id="produ" class="col-6 m-4" style="display: flex; padding-top:0px;">
                        <div class="tema ms-4 h-4">
                          <p class="tema h3"> Pantalon Largo GUESS </p>
                          <hr class="separacion border border-2 border-dark">
                          <div class="descripcion mb-5">
                            <h4>Descripcion:</h4>
                            <p>Los pantalones Guess Originals X Betty Boop Vino Velour son una prenda elegante y llamativa, fruto de una colaboración icónica. Confeccionados en terciopelo de color vino, estos pantalones ofrecen un tacto suave y un aspecto lujoso. El diseño incluye detalles exclusivos de Betty Boop, añadiendo un toque divertido y retro. Su ajuste cómodo y estilizado los convierte en una opción perfecta para un look casual pero sofisticado. Ideales para destacar con estilo y comodidad en cualquier ocasión.</p>
